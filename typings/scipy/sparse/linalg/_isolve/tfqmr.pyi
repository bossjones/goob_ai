...
def tfqmr(A, b, x0=..., *, tol=..., maxiter=..., M=..., callback=..., atol=..., rtol=..., show=...): # -> tuple[ndarray[Any, dtype[Any]], Literal[0]] | tuple[NDArray[Any] | ndarray[Any, dtype[Any]] | ndarray[Any, Any], Literal[0]] | tuple[NDArray[Any] | ndarray[Any, dtype[Any]] | ndarray[Any, Any] | Any, Literal[-1]] | tuple[Any, Literal[0]] | tuple[NDArray[Any] | ndarray[Any, dtype[Any]] | ndarray[Any, Any] | Any, int | Any]:
    """
