...
# from goob_ai.core.base import GoobAIBase
...
# from goob_ai.utils.checks import ifnone
# from goob_ai.utils.conversions import (
#     bytes_to_pil,
# )
...
# LOGGER = get_logger(__name__, provider="goob_ai.backend.discord", level=logging.DEBUG)


# class DiscordClient(GoobAIBase):
...
#         self.command_prefixes = ifnone(command_prefixes, default=[">", "goob_ai "])
